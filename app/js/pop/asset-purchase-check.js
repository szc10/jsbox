 UIActivity['asset-purchase-check'] = {
     activityName: "asset-purchase-check",
     init: function(id) {
         var comData = null;
         activitypoint = this;
         /**
         ...
         xhrSend("Select_all_info/get_info", {}, function(data) {
             comData = data;
             xhrSend("Assetpurchase_control/select_assetpur", { assetpur_id: id }, function(data) {
         ...
         /**
          * 当资产类型发生改变时，折扣年限也随之发生改变，但是折扣年限本身也是可以选择的
          */
         ...
         Action.click('btn_finish', function() {
             ...
             postdata.assetpur_id = id;
             console.log(postdata);

             xhrSend("Assetpurchase_control/boss_check_assetpur", postdata, function(data) {
                 console.log(data);
                 activitypoint.close();
             });
         });
