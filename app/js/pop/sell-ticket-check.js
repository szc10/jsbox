 UIActivity['sell-ticket-check'] = {
     activityName: "sell-ticket-check",
     init: function(id) {
         var comData = null;
         activitypoint = this;
          ...
          */
          xhrSend("Select_all_info/get_info",{},function(data){
              comData = data;
             xhrSend("Sell_list_control/select_sell",{sell_id:id},function(data){
         ...
         Action.click('btn_finish', function() {
             ...
             xhrSend("Sell_list_control/boss_check_sell", postdata, function(data) {
                 console.log(data);
                 activitypoint.close();
             });
         });
