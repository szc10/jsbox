 UIActivity['store-good-check'] = {
     activityName: "store-good-check",
     init: function(id) {
         var comData = null;
            activitypoint = this;
            /**
          ...
          */
            xhrSend("Select_all_info/get_info",{},function(data){
              comData = data;
             xhrSend("Storepurchase_control/select_storepur",{storepur_id:id},function(data){
          ...
          */
            ...
            */
            Action.click('btn_finish',function(){
                  ...
                  postdata.storepur_id = id;
                  console.log(postdata);

                  xhrSend("Storepurchase_control/boss_check_storepur",postdata,function(data){
                      console.log(data);
                      activitypoint.close();  //关闭窗口
                  });
            });
     }
 }