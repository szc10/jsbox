 UIActivity['cost-input']= {
        activityName: "cost-input",
        init: function () {
        	  var comData = null;
            activitypoint = this;
            /**
        ...
        */
        function computeTotal(inputArr,dataType,currentClassName) {
          ...
          /**
          *点击业务说明中的delete按钮就将这条费用说明从费用说明列表中删除
          *同时获取这条删除记录的应交税金的值，并将其从总的税金中减去
          */
        ...
        /**
          ...
          */
          Action.click('btn_finish',function(){
              ...
              xhrSend("Expenditure_control/boss_insert_expense",postdata,function(data){
                  console.log(data);
              });
          });
